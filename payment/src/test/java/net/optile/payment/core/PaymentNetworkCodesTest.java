...
public class PaymentNetworkCodesTest {
    ...
    @Test
    public void isPaymentNetworkCode_invalidValue_false() {
        assertFalse(PaymentNetworkCodes.isValid("foo"));
    }

    @Test
    public void isPaymentNetworkCode_validValue_true() {
        ...
        assertTrue(PaymentNetworkCodes.isValid(PaymentNetworkCodes.JCB));
