...
public class AccountRegistration {
	 ...
	 *
	 * @param selected <code>true</code> means that this account registration is selected, <code>false</code> and <code>null</code> means it
	 *            is not.
	 */
	 ...
	 * @see ApplicableNetwork#getSelected()
	 */
